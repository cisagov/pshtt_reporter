...
```console
docker run cisagov/pshtt_reporter:1.2.6
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/pshtt_reporter:1.2.6
    ```
...
|-----------|-------------|
|`cisagov/pshtt_reporter:1.2.6`| An exact release version. |
...
```console
docker build \
  --tag cisagov/pshtt_reporter:1.2.6 \
