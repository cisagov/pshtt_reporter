...
```console
docker run cisagov/pshtt_reporter:1.1.14
```
...
1. Pull the new image:
    ...
    ```console
    docker pull cisagov/pshtt_reporter:1.1.14
    ```
...
|-----------|-------------|
|`cisagov/pshtt_reporter:1.1.14`| An exact release version. |
...
```console
docker build \
  --tag cisagov/pshtt_reporter:1.1.14 \
